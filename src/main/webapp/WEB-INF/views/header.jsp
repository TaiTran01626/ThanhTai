			...
			<div class="container">
				<div class="h_menu4">
					...
					<ul class="nav">
						...
						<li id="s" class="active" style="background: rgba(0, 0, 0, 0.4)">
						<a id="menu" href="home?page=1&limit=3" id="menu"> <springmess:message code="label.menu1" /> </a></li>
						<li id="s"><a id="menu" href="search"><springmess:message code="label.menu5" /></a></li>
							
						<li id="s" style="background: rgba(0, 0, 0, 0.4); color: white;"><a
							id="menu" href="showAllNews?page=1&limit=3"><springmess:message code="label.allNews" /></a>
							</li>
						<li id="s"><a id="menu" href="post_news"><springmess:message code="label.menu2"/></a></li>

						<li id="s" style="background: rgba(0, 0, 0, 0.4); color: white;"><a
							id="menu" href="guide"><springmess:message code="label.menu3" /></a></li>
						<li id="s"><a id="menu" href="contact"><springmess:message code="label.menu4" /></a></li>
