	...
	<div id="content" style="background: rgba(0, 0, 0, 0)">
		...
		<div>
			...
			<h3 style="color: white;">Danh Sách Bài Đăng Cho Thuê Của Thành
				Viên</h3>
			<form action="<c:url value='/admin/list-comment'/>" id="formSubmit"
				method="get">
				<table id="danhmuc">
					<tr style="width: 100%">
						<th>Mã bình luận</th>
					...
					<c:forEach items="${model.commentEntities}" var="comment">
						<tr>
							<td>${comment.id}</td>
						...
						<c:choose>
							...
							<td><span><a
									href="view-detail-post-news?id=${comment.post.id}"><i
										class="fas fa-eye">Xem chi tiết</i></a></span> <span><a
									href="delete-post-news?id=${comment.id}"><i
